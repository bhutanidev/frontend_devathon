...
const Login = () => {
    return (
        <div className="font-sans">
            <div className="relative min-h-screen flex flex-col sm:justify-center items-center bg-gray-100 pt-4">
                    ...
                    <div className="relative w-full rounded-3xl px-6 py-4 bg-gray-100 shadow-md">
                        ...
                        <form method="#" action="#" className="mt-10">
                            ...
                            <div className="flex mt-7 justify-center w-full">
                                <button className="mr-5 bg-cyan-500 border-none px-4 py-2 rounded-xl cursor-pointer text-white shadow-xl hover:shadow-inner transition duration-500 ease-in-out transform hover:-translate-x hover:scale-105">
                                    Facebook
                                </button>
                                <button className="bg-indigo-600 border-none px-4 py-2 rounded-xl cursor-pointer text-white shadow-xl hover:shadow-inner transition duration-500 ease-in-out transform hover:-translate-x hover:scale-105">
                                    Google
                                </button>
                            </div>
                            <div className="mt-7">
                                <div className="flex justify-center items-center">
                                  //make it a navlink
                                    <label className="mr-2">Register Here</label>
                                </div>
                            </div>
                        </form>
                    </div>
